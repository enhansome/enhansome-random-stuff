...
* [Recordly](https://github.com/webadderall/Recordly) ⭐ 23,236 | 🐛 284 | 🌐 TypeScript | 📅 2026-09-03 — Recordly is a powerful open-source screen recorder and editor for professional product videos, demos, and tutorials. Adds auto-zooms, webcam overlays, cursor animations and more to your recordings. - webadderall/Recordly
...
* [ncdai/chanhdai.com](https://github.com/ncdai/chanhdai.com?utm_source=chanhdai.com) ⭐ 2,244 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-03 — A minimal, pixel-perfect dev portfolio, component registry, and blog. - ncdai/chanhdai.com
...
* [TypeStrong/typedoc](https://github.com/TypeStrong/TypeDoc) ⭐ 8,450 | 🐛 18 | 🌐 TypeScript | 📅 2026-07-13 — Documentation generator for TypeScript projects. Contribute to TypeStrong/typedoc development by creating an account on GitHub.
...
* [qwibitai/nanoclaw](https://github.com/qwibitai/nanoclaw/tree/main) ⭐ 30,695 | 🐛 1,085 | 🌐 TypeScript | 📅 2026-09-03 — A lightweight alternative to Clawdbot / OpenClaw that runs in containers for security. Connects to WhatsApp, has memory, scheduled jobs, and runs directly on Anthropic's Agents SDK - qwibitai/nanoclaw
...
* [blackboardsh/electrobun](https://github.com/blackboardsh/electrobun) ⭐ 12,752 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-30 — Build ultra fast, tiny, and cross-platform desktop apps with Typescript. - blackboardsh/electrobun
...
* [jamiepine/voicebox](https://github.com/jamiepine/voicebox) ⭐ 52,242 | 🐛 671 | 🌐 TypeScript | 📅 2026-08-09 — The open-source voice synthesis studio powered by Qwen3-TTS. - jamiepine/voicebox
...
* [cli/cli](https://github.com/cli/cli) ⭐ 46,129 | 🐛 1,069 | 🌐 Go | 📅 2026-09-03 - GitHub’s official command line tool.

### April 11, 2020

* [bash-guide](https://github.com/Idnan/bash-guide) ⭐ 12,375 | 🐛 27 | 📅 2024-08-11 - A guide to learn bash.
