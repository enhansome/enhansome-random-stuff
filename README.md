...
* [xandemon/developer-icons](https://github.com/xandemon/developer-icons) ⭐ 2,649 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-08 — A collection of well-optimized SVG tech logos for developers and designers—customizable, scalable, and free. - xandemon/developer-icons
...
* [Recordly](https://github.com/webadderall/Recordly) ⭐ 29,826 | 🐛 380 | 🌐 TypeScript | 📅 2026-09-19 — Recordly is a powerful open-source screen recorder and editor for professional product videos, demos, and tutorials. Adds auto-zooms, webcam overlays, cursor animations and more to your recordings. - webadderall/Recordly
...
* [ncdai/chanhdai.com](https://github.com/ncdai/chanhdai.com?utm_source=chanhdai.com) ⭐ 2,280 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-19 — A minimal, pixel-perfect dev portfolio, component registry, and blog. - ncdai/chanhdai.com
...
* [TypeStrong/typedoc](https://github.com/TypeStrong/TypeDoc) ⭐ 8,454 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-13 — Documentation generator for TypeScript projects. Contribute to TypeStrong/typedoc development by creating an account on GitHub.
...
* [qwibitai/nanoclaw](https://github.com/qwibitai/nanoclaw/tree/main) ⭐ 30,805 | 🐛 1,066 | 🌐 TypeScript | 📅 2026-09-19 — A lightweight alternative to Clawdbot / OpenClaw that runs in containers for security. Connects to WhatsApp, has memory, scheduled jobs, and runs directly on Anthropic's Agents SDK - qwibitai/nanoclaw
...
* [blackboardsh/electrobun](https://github.com/blackboardsh/electrobun) ⭐ 12,795 | 🐛 119 | 🌐 TypeScript | 📅 2026-09-17 — Build ultra fast, tiny, and cross-platform desktop apps with Typescript. - blackboardsh/electrobun
...
* [jamiepine/voicebox](https://github.com/jamiepine/voicebox) ⭐ 55,192 | 🐛 699 | 🌐 TypeScript | 📅 2026-08-09 — The open-source voice synthesis studio powered by Qwen3-TTS. - jamiepine/voicebox
...
* [cli/cli](https://github.com/cli/cli) ⭐ 46,333 | 🐛 1,088 | 🌐 Go | 📅 2026-09-19 - GitHub’s official command line tool.

### April 11, 2020

* [bash-guide](https://github.com/Idnan/bash-guide) ⭐ 12,381 | 🐛 27 | 📅 2024-08-11 - A guide to learn bash.
